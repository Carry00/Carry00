...
|---|---|---|
| [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | [fix(runtime): reuse model.api_key for auxiliary tasks on the same custom endpoint](https://github.com/NousResearch/hermes-agent/pull/40406) | 🟡 open |
